 ...
 ******************************************************************************/
package shaded.com.univocity.parsers.common.input;

import shaded.com.univocity.parsers.common.AbstractParser;
import shaded.com.univocity.parsers.common.CommonParserSettings;
...
public interface CharInputReader extends CharInput {
	...
	/**
	 * Initializes the CharInputReader implementation with a {@link Reader} which provides access to the input.
	 *
	 * @param reader A {@link Reader} that provides access to the input.
	 */
	void start(Reader reader);

	/**
	 * Stops the CharInputReader from reading characters from the {@link Reader} provided in {@link CharInputReader#start(Reader)} and closes it.
	 */
	void stop();
