 ...
 * <li>{@link BeanProcessor}: used for automatically create and populate javabeans annotated with the annotations provided in package {@link shaded.com.univocity.parsers.annotations}</li>
