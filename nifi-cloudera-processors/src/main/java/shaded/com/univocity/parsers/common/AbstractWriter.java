 ...
 ******************************************************************************/
package shaded.com.univocity.parsers.common;

import shaded.com.univocity.parsers.common.fields.ExcludeFieldNameSelector;
import shaded.com.univocity.parsers.common.fields.FieldIndexSelector;
import shaded.com.univocity.parsers.common.fields.FieldNameSelector;
import shaded.com.univocity.parsers.common.fields.FieldSelector;
import shaded.com.univocity.parsers.common.input.CharAppender;
import shaded.com.univocity.parsers.common.input.WriterCharAppender;
import shaded.com.univocity.parsers.common.processor.RowWriterProcessor;
import shaded.com.univocity.parsers.common.processor.RowWriterProcessorSwitch;
import shaded.com.univocity.parsers.common.record.Record;
import shaded.com.univocity.parsers.csv.CsvWriter;
import shaded.com.univocity.parsers.csv.CsvWriterSettings;
import shaded.com.univocity.parsers.fixed.FixedWidthWriter;
import shaded.com.univocity.parsers.fixed.FixedWidthWriterSettings;
import shaded.com.univocity.parsers.tsv.TsvWriter;
import shaded.com.univocity.parsers.tsv.TsvWriterSettings;
...
public abstract class AbstractWriter<S extends CommonWriterSettings<?>> {
	 ...
	 * <strong>Important: </strong> by not providing an instance of {@link Writer} to this constructor, only the operations that write to Strings are
	 * available.
	 *
	 ...
	 * {@link FixedWidthWriter} whose {@link FixedWidthWriterSettings#getWriteLineSeparatorAfterRecord()} evaluates to {@code false}. The newline character sequence will conform to what is specified in {@link Format#getLineSeparator()}
	...
	/**
	 * Writes an empty line to the output, unless this is a {@link FixedWidthWriter} whose
	 * {@link FixedWidthWriterSettings#getWriteLineSeparatorAfterRecord()} evaluates to {@code false}.
	 * The newline character sequence will conform to what is specified in {@link Format#getLineSeparator()}
	 * The output will remain open for further writing.
	 */
	...
	/**
	 * Flushes the {@link Writer} given in this class constructor.
	...
	/**
	 * Closes the {@link Writer} given in this class constructor.
	...
	/**
	 * In case of any exceptions, a {@link TextWritingException} is thrown, and the output {@link Writer} is closed.
	 *
	...
	/**
	 * Writes values from an implementation of {@link Map} to a partial output record, ready to be
