 ...
 ******************************************************************************/
package shaded.com.univocity.parsers.conversions;

import shaded.com.univocity.parsers.annotations.Convert;
import shaded.com.univocity.parsers.common.processor.ObjectRowProcessor;
import shaded.com.univocity.parsers.common.processor.ObjectRowWriterProcessor;
 ...
 * <p>
 * Annotations in package {@link shaded.com.univocity.parsers.annotations} are associated with different Conversion
 * implementations in {@link shaded.com.univocity.parsers.conversions}.
 *
 ...
 *            <p>
 *            When used in conjunction with the {@link Convert} annotation,
...
public interface Conversion<I, O> {
     ...
     * <p>
     * When used in conjunction with the {@link Convert} annotation, this method will perform
     ...
     * <p>
     * When used in conjunction with the {@link Convert} annotation, this method will
