 ...
 ******************************************************************************/
package shaded.com.univocity.parsers.common.input.concurrent;

import shaded.com.univocity.parsers.common.Format;
import shaded.com.univocity.parsers.common.input.AbstractCharInputReader;
import shaded.com.univocity.parsers.common.input.BomInput;
import shaded.com.univocity.parsers.common.input.CharInputReader;
import shaded.com.univocity.parsers.common.input.DefaultCharInputReader;
...
public class ConcurrentCharInputReader extends AbstractCharInputReader {
    ...
    /**
     * Stops the CharInputReader from reading characters from the {@link Reader} provided in {@link ConcurrentCharInputReader#start(Reader)} and closes it.
