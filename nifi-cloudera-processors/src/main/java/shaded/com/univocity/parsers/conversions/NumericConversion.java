...
/**
 * Converts Strings to instances of {@link Number} and vice versa.
 *
 ...
 * <p> The numeric patterns must follows the pattern rules of {@link DecimalFormat}
 *
...
public abstract class NumericConversion<T extends Number> extends ObjectConversion<T> implements FormattedConversion<DecimalFormat> {
	...
	/**
	 * Defines a conversion from String to {@link Number} using a sequence of acceptable numeric patterns.
	...
	/**
	 * Defines a conversion from String to {@link Number} using a sequence of acceptable numeric patterns. The patterns
