 ...
 ******************************************************************************/
package shaded.com.univocity.parsers.common.routine;

import shaded.com.univocity.parsers.annotations.Nested;
import shaded.com.univocity.parsers.annotations.Parsed;
import com.univocity.parsers.common.*;
import shaded.com.univocity.parsers.common.*;
import shaded.com.univocity.parsers.common.fields.ColumnMapper;
import shaded.com.univocity.parsers.common.fields.ColumnMapping;
import com.univocity.parsers.common.processor.*;
import shaded.com.univocity.parsers.common.processor.*;
...
public abstract class AbstractRoutines<P extends CommonParserSettings<?>, W extends CommonWriterSettings<?>> {
	...
	/**
	 * Dumps the content of a {@link ResultSet} into a file.
	 *
	 * @param rs     the {@link ResultSet} whose contents should be read and written to a given output
	 * @param output the output file that will store the data in the given {@link ResultSet}
	...
	/**
	 * Dumps the content of a {@link ResultSet} into an output stream.
	 *
	 * @param rs     the {@link ResultSet} whose contents should be read and written to a given output
	 * @param output the output stream that will store the data in the given {@link ResultSet}
	 *               in the format specified by concrete implementations of this class.
	 */
	...
	/**
	 * Dumps the content of a {@link ResultSet}.
	 *
	 * @param rs     the {@link ResultSet} whose contents should be read and written to a given output
	 * @param output the output that will store the data in the given {@link ResultSet}
	 *               in the format specified by concrete implementations of this class.
	 */
