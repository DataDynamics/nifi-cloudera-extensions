...
public abstract class AbstractCharInputReader implements CharInputReader {
	...
	/**
	 * Passes the {@link Reader} provided in the {@link AbstractCharInputReader#start(Reader)} method to the extending class so it can begin loading characters from it.
	 *
	 * @param reader the {@link Reader} provided in {@link AbstractCharInputReader#start(Reader)}
	 */
